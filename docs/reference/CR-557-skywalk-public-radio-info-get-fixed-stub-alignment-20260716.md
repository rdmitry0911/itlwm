# CR-557 — Skywalk public RADIO_INFO GET fixed-stub alignment

Date: 2026-07-16

## Scope

This layer aligns only the current 25C56 public APPLE80211_IOC_RADIO_INFO
(IOC 54) Tahoe BSD GET direction in
...
No local Tahoe RADIO_INFO carrier contract is inferred from the direct current
public getter. This layer neither constructs nor consumes a carrier. Legacy V1
has a separate RADIO_INFO route and producer; Virtual IOCTL does not name IOC
54. The card-specific route has no RADIO_INFO entry and continues to exclude it
through TahoeSkywalkIoctlRoutes::shouldRoute's false default.
...
apple80211getRADIO_INFO at nlist 7244 in the half-open VM range
0xffffff80021bee62..0xffffff80021bee6d, file range
0x20bee62..0x20bee6d. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-radio-info-get-public-fixed-stub-bootkc-current/.

## Boundary and non-claims

This is an exact, narrow public GET status alignment. It does not claim
outer-null dispatch behavior, a Tahoe RADIO_INFO carrier contract, SET behavior,
radio-info behavior, legacy V1 behavior, Virtual IOCTL, card-specific behavior,
firmware, runtime-execution, radio operation, association, traffic, or broader
...
scripts/skywalk_public_radio_info_get_fixed_stub_alignment_report.py --check
...
without Tahoe carrier access, and active Tahoe source-phase markers.
