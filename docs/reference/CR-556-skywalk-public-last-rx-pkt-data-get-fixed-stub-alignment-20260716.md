# CR-556 — Skywalk public LAST_RX_PKT_DATA GET fixed-stub alignment
...
APPLE80211_IOC_LAST_RX_PKT_DATA (IOC 53) Tahoe BSD GET direction in
...
No local LAST_RX_PKT_DATA carrier contract is inferred from the direct current
public getter. This layer neither constructs nor consumes a carrier. Historical
V1 and Virtual IOCTL routes do not name IOC 53. The card-specific route has no
LAST_RX_PKT_DATA entry and continues to exclude it through
...
apple80211getLAST_RX_PKT_DATA at nlist 7656 in the half-open VM range
0xffffff80021bee57..0xffffff80021bee62, file range
0x20bee57..0x20bee62. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-last-rx-pkt-data-get-public-fixed-stub-bootkc-current/.
...
scripts/skywalk_public_last_rx_pkt_data_get_fixed_stub_alignment_report.py
