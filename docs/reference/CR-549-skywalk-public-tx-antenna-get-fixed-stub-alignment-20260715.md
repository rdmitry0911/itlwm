# CR-549 — Skywalk public TX_ANTENNA GET fixed-stub alignment

Date: 2026-07-15

## Scope

This layer aligns only the current 25C56 public APPLE80211_IOC_TX_ANTENNA
(IOC 37) Tahoe BSD GET direction in
...
Virtual IOCTL does not name IOC 37. The card-specific route has no TX_ANTENNA
entry and continues to exclude it through TahoeSkywalkIoctlRoutes::shouldRoute's
false default.
...
apple80211getTX_ANTENNA at nlist 7252 in the half-open VM range
0xffffff80021beae7..0xffffff80021beaf2, file range
0x20beae7..0x20beaf2. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-tx-antenna-get-public-fixed-stub-bootkc-current/.

## Boundary and non-claims

This is an exact, narrow Skywalk public GET status alignment. It does not
claim outer-null dispatch behavior, a TX_ANTENNA Skywalk carrier contract, SET
behavior, antenna behavior, legacy V1 behavior, Virtual IOCTL, card-specific
