# CR-546 — Skywalk public MULTICAST_RATE GET fixed-stub alignment
...
APPLE80211_IOC_MULTICAST_RATE (IOC 34) Tahoe BSD GET direction in
...
switch. SET behavior is separately aligned and documented by CR-591; this
GET evidence does not independently prove SET behavior.

No local MULTICAST_RATE carrier contract is inferred from the direct current
public getter. This layer neither constructs nor consumes a carrier.

Historical V1 and Virtual IOCTL routes do not name IOC 34. The card-specific
route has no MULTICAST_RATE entry and continues to exclude it through
...
apple80211getMULTICAST_RATE at nlist 7507 in the half-open VM range
0xffffff80021beac6..0xffffff80021bead1, file range
0x20beac6..0x20bead1. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-multicast-rate-get-public-fixed-stub-bootkc-current/.

## Boundary and non-claims

This is an exact, narrow public GET status alignment. It does not claim
outer-null dispatch behavior, a MULTICAST_RATE carrier contract,
multicast-rate behavior, V1, Virtual IOCTL, card-specific behavior, firmware,
runtime-execution, radio, association, traffic, or broader Tahoe behavior
parity. SET behavior is separately aligned and documented by CR-591; this GET
...
scripts/skywalk_public_multicast_rate_get_fixed_stub_alignment_report.py
...
markers. SET has separate raw evidence and contract coverage in CR-591.
