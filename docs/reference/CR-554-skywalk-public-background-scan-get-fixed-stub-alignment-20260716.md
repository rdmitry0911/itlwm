# CR-554 — Skywalk public BACKGROUND_SCAN GET fixed-stub alignment

Date: 2026-07-16

## Scope

This layer aligns only the current 25C56 public APPLE80211_IOC_BACKGROUND_SCAN
(IOC 47) Tahoe BSD GET direction in
...
No local BACKGROUND_SCAN carrier contract is inferred from the direct current
public getter. This layer neither constructs nor consumes a carrier. Historical
V1 and Virtual IOCTL routes do not name IOC 47. The card-specific route has no
BACKGROUND_SCAN entry and continues to exclude it through
...
apple80211getBACKGROUND_SCAN at nlist 7572 in the half-open VM range
0xffffff80021bece5..0xffffff80021becf0, file range
0x20bece5..0x20becf0. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-background-scan-get-public-fixed-stub-bootkc-current/.

## Boundary and non-claims

This is an exact, narrow public GET status alignment. It does not claim
outer-null dispatch behavior, a BACKGROUND_SCAN carrier contract, SET behavior,
background-scan behavior, V1, Virtual IOCTL, card-specific behavior, firmware,
...
scripts/skywalk_public_background_scan_get_fixed_stub_alignment_report.py
--check checks the direct raw record and manifest, exact Tahoe-only GET case,
absent pre-26 source case, separated V1/Virtual/card seams, selector declaration
