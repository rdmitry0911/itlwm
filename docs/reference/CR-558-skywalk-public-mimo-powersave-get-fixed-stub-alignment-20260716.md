# CR-558 — Skywalk public MIMO_POWERSAVE GET fixed-stub alignment
...
APPLE80211_IOC_MIMO_POWERSAVE (IOC 56) Tahoe BSD GET direction in
...
No local MIMO_POWERSAVE carrier contract is inferred from the direct current
public getter. This layer neither constructs nor consumes a carrier. Historical
V1 and Virtual IOCTL routes do not name IOC 56. The card-specific route has no
MIMO_POWERSAVE entry and continues to exclude it through
...
apple80211getMIMO_POWERSAVE at nlist 7505 in the half-open VM range
0xffffff80021beec2..0xffffff80021beecd, file range
0x20beec2..0x20beecd. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-mimo-powersave-get-public-fixed-stub-bootkc-current/.

## Boundary and non-claims

This is an exact, narrow public GET status alignment. It does not claim
outer-null dispatch behavior, a MIMO_POWERSAVE carrier contract, SET behavior,
MIMO-powersave behavior, V1, Virtual IOCTL, card-specific behavior, firmware,
...
scripts/skywalk_public_mimo_powersave_get_fixed_stub_alignment_report.py
