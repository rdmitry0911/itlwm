# CR-544 — Skywalk public FRAG_THRESHOLD GET fixed-stub alignment
...
APPLE80211_IOC_FRAG_THRESHOLD (IOC 31) Tahoe BSD GET direction in
...
direct current public getter provides no evidence that the declaration is an
active public carrier contract.

Historical V1 and Virtual IOCTL routes do not name IOC 31. The card-specific
route has no FRAG_THRESHOLD entry and continues to exclude it through
...
apple80211getFRAG_THRESHOLD at nlist 7499 in the half-open VM range
0xffffff80021bea5b..0xffffff80021bea66, file range
0x20bea5b..0x20bea66. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-frag-threshold-get-public-fixed-stub-bootkc-current/.
...
scripts/skywalk_public_frag_threshold_get_fixed_stub_alignment_report.py
