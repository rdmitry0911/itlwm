# CR-545 — Skywalk public SHORT_SLOT GET fixed-stub alignment

Date: 2026-07-15

## Scope

This layer aligns only the current 25C56 public APPLE80211_IOC_SHORT_SLOT
(IOC 33) Tahoe BSD GET direction in
...
public getter provides no evidence that the declaration is an active public
carrier contract.

Historical V1 and Virtual IOCTL routes do not name IOC 33. The card-specific
route has no SHORT_SLOT entry and continues to exclude it through
...
apple80211getSHORT_SLOT at nlist 7249 in the half-open VM range
0xffffff80021beabb..0xffffff80021beac6, file range
0x20beabb..0x20beac6. It is an N_SECT|N_EXT record (type 0x0f, section 1,
...
preserved under
docs/reference/artifacts/skywalk-short-slot-get-public-fixed-stub-bootkc-current/.
