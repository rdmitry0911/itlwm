#!/usr/bin/env python3
"""Generate and verify Skywalk public INT_MIT GET fixed-stub evidence."""
...
OUTPUT = ROOT / "evidence/state/skywalk_public_int_mit_get_fixed_stub_alignment_report.json"
NOTE = ROOT / "docs/reference/CR-534-skywalk-public-int-mit-get-fixed-stub-alignment-20260715.md"
RAW = ROOT / "docs/reference/artifacts/skywalk-int-mit-get-public-fixed-stub-bootkc-current/raw.txt"
...
def report():
    ...
    return {
        "schema": "itlwm-skywalk-public-int-mit-get-fixed-stub-alignment-v1",
        "source_base_revision": "7b7a64f7b67a6c1ccce9e5f779543f681f3b9c8c",
        "reference": {
            "bootkc_sha256": "eb5691e94b750df8316f8474245966e02d1badd696f78aa27f003766c9bff06d",
            "bootkc_uuid": "F0ACEF59-61D0-DEDC-C1D2-BECE30DD94E5",
            "embedded_kext_uuid": "8FB4B7F0-D656-3539-B8D6-C1327A50377C",
            "nlist_index": 7095,
            "public_wrapper": "0xffffff80021be89c",
            "next_symbol": "0xffffff80021be8a7",
        ...
        "checks": {
            ...
            "reference_raw_has_exact_unread_public_get_fixed_stub": all(
                ...
                for token in (
                    ...
                    "symbol=__Z20apple80211getINT_MITP23IO80211SkywalkInterfacePv",
                    "nlist_index=7095",
                    "n_type=0x0f",
                    "n_sect=1",
                    "n_desc=0x0000",
                    "symbol_vmaddr=0xffffff80021be89c",
                    "symbol_vmaddr_end=0xffffff80021be8a7",
                    "symbol_fileoff=0x20be89c",
                    "symbol_fileoff_end=0x20be8a7",
                    "symbol_bytes=0x0b",
                    "next_nlist_index=7054",
                    "__Z18apple80211getPOWERP23IO80211SkywalkInterfaceP21apple80211_power_data",
                    "next_symbol_vmaddr=0xffffff80021be8a7",
                    "body_sha256=9e4580f0175946d7624b2451e6ffda84a93e91e3e2d852d7a2c7998ee2d78576",
                    "0xe082280e",
            ...
            "note_records_scope_and_nonclaims": all(
                ...
                for token in (
                    ...
                    "0xffffff80021be89c",
                    "0xe082280e",
                    "compile-time Tahoe-only",
                    "normal non-null Tahoe BSD GET",
                    "card-specific route remains excluded",
                    "does not claim outer-null, carrier/ABI, SET, V1/helper, Virtual IOCTL, card-specific, association, firmware, runtime-execution, or broader Tahoe behavior parity",
...
def main():
    ...
    if failed:
        raise ValueError(
            "Skywalk public INT_MIT GET alignment validation failed: "
            + ", ".join(failed)
        )
...
if __name__ == "__main__":
    try:
        ...
        print(
            f"Skywalk public INT_MIT GET alignment validation failed: {exc}",
            file=sys.stderr,
        )
        sys.exit(1)
