...
require_literal 'ssh -F /dev/null -p 3322' 'ambient SSH configuration disabled'
...
require_literal 'UpdateHostKeys=no' 'host-key rotation disabled'
...
forbid_literal 'UserKnownHostsFile=/dev/null' 'discarded host-key trust store'
