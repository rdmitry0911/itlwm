...
for needle, label in (
    ...
    ("os.O_EXCL", "new private receipt output gate"),
    ("O_NOFOLLOW", "no-follow private receipt output gate"),
    ("0o600", "private candidate receipt mode"),
    ("receipt output post-write verification failed", "private receipt post-write fence"),
