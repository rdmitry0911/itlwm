...
bash "$ROOT/scripts/test_tahoe_wcl_link_down_reconnect_contract.sh"
bash "$ROOT/scripts/test_tahoe_wcl_disassociate_link_down_contract.sh"
bash "$ROOT/scripts/test_tahoe_wcl_power_off_link_down_contract.sh"
...
bash "$ROOT/scripts/test_tahoe_auxkc_activate_release_contract.sh"
bash "$ROOT/scripts/test_tahoe_release_auxkc_preflight_result_contract.sh"
bash "$ROOT/scripts/test_tahoe_iwn_candidate_activation_reboot_contract.sh"
...
bash -n "$ROOT/scripts/tahoe_auxkc_activate_release.sh"
bash -n "$ROOT/scripts/run_tahoe_iwn_candidate_activation_reboot.sh"
