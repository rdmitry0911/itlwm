...
bash "$root/scripts/test_net80211_assoc_comeback_contract.sh"
bash "$root/scripts/test_iwm_iwx_assoc_comeback_prepare_contract.sh"
bash "$root/scripts/test_tahoe_iwn_sae_wcl_ingress_contract.sh"
bash "$root/scripts/test_tahoe_sae_card_capability_contract.sh"
